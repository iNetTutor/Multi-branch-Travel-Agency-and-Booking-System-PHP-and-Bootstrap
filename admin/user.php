      ...
      <div class="content-wrapper">
         ...
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                        <h1 class="m-0" style="color: rgb(31,108,163);"><span class="fa fa-user-lock"></span> Admin Account</h1>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-6">
                  ...
                  <table id="example1" class="table table-bordered table-hover">
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td class="text-right">
                              <a class="btn btn-sm btn-success" href="edit-admin.php"><i class="fa fa-edit"></i> update</a>
                           </td>
                        </tr>
                        </tbody>
                  </table>
