      ...
      <div class="content-wrapper">
         ...
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                        <h1 class="m-0" style="color: rgb(31,108,163);"><span class="fa fa-landmark"></span> Travel Agency Office</h1>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-6">
            ...
            <div class="container-fluid">
               ...
               <div class="col-md-12 table-responsive"><br>
                  <table id="example1" class="table table-bordered table-hover">
                     ...
                     <tbody>
                        <tr>
                           <td><img src="../asset/img/logo.png" width="50" style="border:2px solid #ddd"></td>
                           <td>APC Travel Agecny</td>
                           <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</td>
                           <td>09856789578</td>
                           <td>apclaw@gmail.com</td>
                           <td class="text-right">
                              <a class="btn btn-sm btn-info" href="agency-details.php"><i class="fa fa-eye"></i> view profile</a>
