         ...
         <div class="content-wrapper">
            ...
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">My Bookings</span>
          ...
          <div class="col-12 col-sm-6 col-md-6">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Number of Tour Agencies</span>
          ...
          <div class="col-12 col-sm-6 col-md-6 offset-md-3">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-indigo elevation-1"><i class="fas fa-bus"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Number of Tour Package</span>
                <span class="info-box-number">20</span>
              </div>
              <!-- /.info-box-content -->
            </div>
