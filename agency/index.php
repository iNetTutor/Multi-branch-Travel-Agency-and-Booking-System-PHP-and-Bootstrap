     ...
     <body class="hold-transition sidebar-mini layout-fixed">
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <div class="info-box">
              <span class="info-box-icon bg-warning elevation-1"><i class="fas fa-bus"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Total Tour Packages</span>
          ...
          <div class="col-12 col-sm-6 col-md-6 offset-md-3">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-indigo elevation-1"><i class="fas fa-money-bill"></i></span>
